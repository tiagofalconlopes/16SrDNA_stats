...
edgeR<- read.csv("~/Documents/16S_rrna/HigVar_simulation/edgeR_high_var.csv")
Deseq2<- read.csv("~/Documents/16S_rrna/HigVar_simulation/Deseq2_high_vars.csv")
stats_16 <- read.delim("~/Documents/16S_rrna/HigVar_simulation/comparisons_compound_or_gene.txt")
aldex2<-read.csv("~/Documents/16S_rrna/HigVar_simulation/Aldo_result_high_var.csv")
